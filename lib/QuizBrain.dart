...
class QuizBrain{
  ...
  final List<Question> _questionBank = [
    Question('You can lead the cow downstairs but not upstairs.', true),
    Question('Approximately one quarter of human bones are in feet.', false),
  ...
  String getQuestion() { return _questionBank[_questionNumber].questionText;}
  bool getAnswer() { return _questionBank[_questionNumber].questionAnswer;}
}